...
const AppointmentHistory = ({ username, onLogout }) => {
  const navigate = useNavigate();
  const [isDropdownVisible, setIsDropdownVisible] = useState(false);
  const [appointments] = useState([
    {
      fullName: 'Agnes T. Aguilera',
      contactNumber: '09482539697',
      emailAddress: 'agnes@gmail.com',
      dateOfAppointment: '2023-12-31',
      reasonOfAppointment: 'Checkup',
      petName: 'Liam',
      status: 'Completed',
    },
    {
      fullName: 'Renz S. Alanano',
      contactNumber: '09612128145',
      emailAddress: 'renz.alanano@gmail.com',
      dateOfAppointment: '2023-12-31',
      reasonOfAppointment: 'Surgery',
      petName: 'Nonie',
      status: 'Re-Sched',
    }
  ]);
  ...
  return (
    <div style={{ display: 'flex', backgroundColor: '#f8f9f9', minHeight: '100vh', padding: '20px' }}>
      ...
      <div style={{ marginLeft: '20%', padding: '20px', width: '80%' }}>
        <h5 style={{ fontWeight: 'lighter' }}>Dashboard / Appointment History</h5>
        <h3 style={{ marginTop: '30px', marginLeft: '30px' }}>My Appointment History</h3>
        <div>
